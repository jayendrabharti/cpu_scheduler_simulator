...
<div className="flex flex-row m-4">
    ...
    <div className="flex flex-row items-center ml-auto">
        ...
        >
            ...
            <option value="srtf" className="bg-black">Shortest Remaining Time First</option>
            <option value="npp" className="bg-black">Priority (Non Preemptive)</option>
            <option value="pp" className="bg-black">Priority (Preemptive)</option>
